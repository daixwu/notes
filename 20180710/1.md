...
![sprite](https://raw.githubusercontent.com/daixwu/notes/master/static/20180710/2.jpg)
...
![img](https://raw.githubusercontent.com/daixwu/notes/master/static/20180710/3.png)
...
![steps](https://raw.githubusercontent.com/daixwu/notes/master/static/20180710/4.png)
...
- 非逐帧动画部分，使用 `rem` 做单位；
- 逐帧动画部分，使用 `px` 做单位，再[结合 `js` 对动画部分使用 `scale` 进行缩放](https://www.cnblogs.com/lyr1213/p/8658002.html)。

From：凹凸实验室（[https://aotu.io/notes/2016/05/17/css3-animation-frame/](https://aotu.io/notes/2016/05/17/css3-animation-frame/)）

推荐：[H5序列帧动画实现过程（附源码）](https://blog.csdn.net/Mr_Zing/article/details/78900519)